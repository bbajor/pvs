...
import de.bbajor.pvs.ivom.dto.DiseaseDto;
import de.bbajor.pvs.ivom.dto.IvomDrugDto;
import de.bbajor.pvs.ivom.dto.IvomPlanDto;
import de.bbajor.pvs.ivom.dto.SideOfEye;
import de.bbajor.pvs.ivom.dto.TimeSlotDto;
import de.bbajor.pvs.patientsearch.dto.PatientDto;

public class IvomForm extends Composite<FormLayout> {
    ...
    final ComboBox<DiseaseDto> diseaseComboBox = new ComboBox<>("Grund der Behandlung");
    ...
    public IvomForm(List<PatientDto> patients) {
