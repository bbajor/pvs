 ...
 * <p>
 * This utility class contains constants and user objects that can be used
 * consistently across development
 * configurations, integration tests, and other testing scenarios. It ensures
 * that the same test users are available in
 * all contexts where they are needed, promoting consistency and reducing
 * duplication.
 * </p>
 * <p>
 * The class provides both the complete {@link DevUser} objects (for use in user
 * details services) and individual
 * constants for user IDs and preferred usernames (for use in tests and
 * assertions). This allows tests to reference
 * specific user properties without needing to extract them from the user
 * objects.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * <strong>Important:</strong> This class is intended only for development and
 * testing purposes. The sample users have
 * fixed, well-known credentials and should never be used in production
 * environments.
 * </p>
 *
...
public final class SampleUsers {
         ...
         * <p>
         * This constant can be used with {@code @WithUserDetails} in tests to
         ...
         * <p>
         * This user has both the "ADMIN" and the "USER" role and can be used in
         * development configurations and tests that
         ...
         * and tests that require standard user
         * access.
         * </p>
         */
         ...
         * <p>
         * This list provides a convenient way to access all sample users at once, which
         * is particularly useful when
         * creating a {@link DevUserDetailsService} that should include all available
         * test users. Using this list ensures
         * that any new sample users added to this class will automatically be included
