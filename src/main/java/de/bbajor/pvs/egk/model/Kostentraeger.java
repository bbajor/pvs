...
public class Kostentraeger {
    ...
    @XmlElement(name = "AbrechnenderKostentraeger", namespace = "http://ws.gematik.de/fa/vsdm/vsd/v5.2")
    private AbrechnenderKostentraeger abrechnender;
    ...
    public AbrechnenderKostentraeger getAbrechnender() {
        return abrechnender;
    }

    public void setAbrechnender(AbrechnenderKostentraeger abrechnender) {
