...
public class IvomDrugNode {
    ...
    private final IntravitrealMedicationDto dto; // nur bei Leaf-Knoten gefüllt

    public IvomDrugNode(String label) {
        this(label, null);
    }

    public IvomDrugNode(String label, IntravitrealMedicationDto dto) {
    ...
    public IntravitrealMedicationDto getDto() {
        return dto;
    }
