...
public class MedicationView extends Main {
    ...
    public MedicationView(MedicationViewPresenter medicationPresenter) {
        ...
        grid.addHierarchyColumn(MedicationNode::getLabel).setHeader("Bezeichnung").setResizable(true)
                .setAutoWidth(true).setWidth("150px");
        grid.addColumn(MedicationNode::getWirkstoffe).setHeader("Wirkstoffe").setResizable(true).setAutoWidth(true)
                .setWidth("150px");
        ...
        grid.addColumn(MedicationNode::getZulassungsinhaber).setHeader("Zulassungsinhaber").setResizable(true)
                .setAutoWidth(true);
        grid.addColumn(MedicationNode::getZulassungsRegNrOderKennziffer)
