...
/**
 * View für die Auswertung "Patienten Kasse/Privat".
 */
@Route("analytics/patients-by-insurance-type")
@PageTitle("Patienten Kasse/Privat - Auswertungen")
@RolesAllowed({ AppRoles.TECH_USER, AppRoles.ADMIN, AppRoles.OWNER })
@Slf4j
@RequiredArgsConstructor
public class PatientsByInsuranceTypeView extends BaseAnalyticsView implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        add(new ViewToolbar("Patienten Kasse/Privat"));
        add(createContent());
    }
    ...
    private VerticalLayout createContent() {
        ...
        try {
            ...
            VerticalLayout card = createChartCard("Patienten Kasse/Privat", chart);
